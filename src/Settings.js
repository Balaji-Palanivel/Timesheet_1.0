                ...
                <div className="p-4 ">
                    ...
                    >
                        <div className="card-body ">
                            <div className="row pt-4 g-2 justify-content-center">
                                ...
                                <div className="col-lg-4 g-4 py-4">
                                    <div><button className="btn btn-info "><FontAwesomeIcon icon={icon.faUserPen} /> &nbsp; Edit</button></div>
                            ...
                            <div className="row pt-4 g-2">
                                ...
                                <div className="row pt-4 g-2">
                                    <button className="btn btn-primary col-sm-4 ">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
